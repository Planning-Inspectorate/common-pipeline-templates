...
| applyStageVariableGroupFormatString | string   | `''`                                | Format string for a variable group linked to the apply stage; `{0}` is replaced with the environment name. When empty, no variable group is linked.                                                                                                    |
